...
public class Task {
    ...
    public Task(UUID id, String title, Text description, LocalDateTime dueDate, TaskPriority priority, TaskStatus status, LocalDateTime created, LocalDateTime updated) {
        this.id = id;
        this.title = title;
